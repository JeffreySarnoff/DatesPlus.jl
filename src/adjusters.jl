...
# Examples
```jldoctest
julia> trunc(DatesPlus.DateTime("1996-01-01T12:30:00"), DatesPlus.Day)
1996-01-01T00:00:00
```
"""
DatesPlus.trunc(::DatesPlus.TimeType, ::Type{DatesPlus.Period})
...
# Examples
```jldoctest
julia> DatesPlus.firstdayofweek(DateTime("1996-01-05T12:30:00"))
1996-01-01T00:00:00
```
"""
...
# Examples
```jldoctest
julia> DatesPlus.lastdayofweek(DateTime("1996-01-05T12:30:00"))
1996-01-07T00:00:00
```
"""
...
# Examples
```jldoctest
julia> DatesPlus.firstdayofmonth(DateTime("1996-05-20"))
1996-05-01T00:00:00
```
"""
...
# Examples
```jldoctest
julia> DatesPlus.lastdayofmonth(DateTime("1996-05-20"))
1996-05-31T00:00:00
```
"""
...
# Examples
```jldoctest
julia> DatesPlus.firstdayofyear(DateTime("1996-05-20"))
1996-01-01T00:00:00
```
"""
...
# Examples
```jldoctest
julia> DatesPlus.lastdayofyear(DateTime("1996-05-20"))
1996-12-31T00:00:00
```
"""
...
# Examples
```jldoctest
julia> DatesPlus.firstdayofquarter(DateTime("1996-05-20"))
1996-04-01T00:00:00

julia> DatesPlus.firstdayofquarter(DateTime("1996-08-20"))
1996-07-01T00:00:00
```
"""
...
# Examples
```jldoctest
julia> DatesPlus.lastdayofquarter(DateTime("1996-05-20"))
1996-06-30T00:00:00

julia> DatesPlus.lastdayofquarter(DateTime("1996-08-20"))
1996-09-30T00:00:00
```
"""
...
# Examples
```jldoctest
julia> Date(date -> DatesPlus.week(date) == 20, 2010, 01, 01)
2010-05-17

julia> Date(date -> DatesPlus.year(date) == 2010, 2000, 01, 01)
2010-01-01

julia> Date(date -> DatesPlus.month(date) == 10, 2000, 01, 01; limit = 5)
...
# Examples
```jldoctest
julia> DateTime(dt -> DatesPlus.second(dt) == 40, 2010, 10, 20, 10; step = DatesPlus.Second(1))
2010-10-20T10:00:40

julia> DateTime(dt -> DatesPlus.hour(dt) == 20, 2010, 10, 20, 10; step = DatesPlus.Hour(1), limit = 5)
ERROR: ArgumentError: Adjustment limit reached: 5 iterations
Stacktrace:
[...]
```
...
# Examples
```jldoctest
julia> DatesPlus.Time(t -> DatesPlus.minute(t) == 30, 20)
20:30:00

julia> DatesPlus.Time(t -> DatesPlus.minute(t) == 0, 20)
20:00:00

julia> DatesPlus.Time(t -> DatesPlus.hour(t) == 10, 3; limit = 5)
ERROR: ArgumentError: Adjustment limit reached: 5 iterations
Stacktrace:
[...]
```
