...
struct DateLocale
    ...
    month_value::Dict{String, Int128}
    month_abbr_value::Dict{String, Int128}
    day_of_week_value::Dict{String, Int128}
    day_of_week_abbr_value::Dict{String, Int128}
end
...
### Days of the Week
"""
    dayofweek(dt::TimeType) -> Int128

Return the day of the week as an [`Int128`](@ref) with `1 = Monday, 2 = Tuesday, etc.`.
